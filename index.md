...
#### 主要从事图机器学习、智能算法安全、知识图谱与知识计算、复杂数据（图数据、时序数据）隐私保护等研究。已在《Knowledge-Based Systems》、《Neurocomputing》、《自动化学报》等国内外权威期刊和会议上正式发表学术论文40余篇，其中SCI检索高水平期刊论文20余篇。研究成果被《PloS one》、《Scientific Reports》、《Computers & Electrical Engineering》等期刊论文引用近百次。
### 教育背景
<html>  
    <head></head>  
    <body>  
...
#### （1）2013.9-2017.6, 电子科技大学, 计算机应用技术, 博士, 导师: 陈雷霆
#### （2）2008.9-2011.6, 重庆邮电大学, 计算机应用技术, 硕士, 导师: 刘宴兵
#### （3）2004.9-2008.6, 兰州理工大学, 计算机应用技术, 学士, 导师: 张远平
### 主要项目
<html>  
    <head></head>  
    <body>  
